...
\begin{enumerate}
 \item     if K is between 640 $<$ K $<=$ 3824 then Kb = 10\\
  ...
  \item    If K is $<=$ 192 then Kb is = 6\\
    \end{enumerate}
 \item    Determine the base matrix expansion factor Zc by selecting the minimum Zc value in below Table, such that Kb*Zc $>=$K\\
Sets of LDPC lifting size Zc in the specification I have populated below Zc table.\\
\vspace{10mm}
   ...
   3 & 16 &24 &40 &56 &72 &88 &104 &120 \\
    \hline
     4 & 32 &48 &80 &112 &144 &196 &208 &240\\
    \hline
     5 & 64 &96 &160 &224 &288 & & &\\
    \hline
     6 & 128 &192 &320 & & & & &\\
