...
I have generated all the posible base graphs and are available in {\href{https://github.com/KrishnaYadati/IIT-H-FWC-Project/tree/main/5G-NR-LDPC-Encoder/Base_Graphs}{BaseGraphs}} section .\\
 ...
 \subsection{\textbf{Encoding procedure}}
  \begin{enumerate} 
 \item First step is to generate any random message of size equal to lifting size (Zc) which has obtained during the selection of base graph.\\
  \item Then Zc should be multiplied with the original information bits i.e., difference between rows and columns for the selected base graph.\\
  \begin{lstlisting}
